...
if(isset($_GET['tag'])&&$_GET['tag']!=NULL){
	...
	$srObj = searchTagsNupedia($tagStr);
...
<main class="main-wrapper">
	...
	<div class="tagHeader"><i class="icon-tag"></i> <?php echo $tagStr;?></div>
