					...
					c = ed.controlManager.createButton('imageleft', {
						...
						onclick : function() {
							...
							if (selHtml != "")
							{
								...
								h = 	'<div id="' + oid + '" class="' + ooki_imageleftObjId + '" style="border:solid 1px black;float:left;padding:5px;">' + 
											'<div style="padding:5px;margin-right:5px;float:left;">' + selHtml + '</div>' + 
											'<div>text</div>' + 
										'</div>';
